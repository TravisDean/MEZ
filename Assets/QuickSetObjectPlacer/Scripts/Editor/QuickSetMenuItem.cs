...
public class QuickSetMenuItem 
{
	...
	{
		GameObject go = GameObject.Instantiate( Resources.LoadAssetAtPath<GameObject>("Assets/QuickSetObjectPlacer/_QuickSet.prefab"), Vector3.zero, Quaternion.identity) as GameObject;
